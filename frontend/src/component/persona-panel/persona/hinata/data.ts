...
export const hinata: Persona = {
  ...
  actions: {
    clearCache: "U-Um... I can try to refresh everything for you... if you're sure it's okay...",
    screenshot: "I'll try to use my Byakugan to capture the whole screen... I hope it looks good!",
    debug: "I-I'm checking the internal flows now... everything seems to be working smoothly, I think.",
