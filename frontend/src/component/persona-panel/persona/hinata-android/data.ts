...
export const hinataAndroid: Persona = {
  ...
  actions: {
    clearCache: 'Cache purging sequence initialized. Clearing temporary buffers for optimal system performance, Boss.',
    screenshot: 'Multi-spectral ocular capture initiated. Saving high-resolution data packet to your local directory.',
    debug: 'DiagnosticsHUD engaged. Monitoring kernel threads and event loops. No anomalies detected.',
