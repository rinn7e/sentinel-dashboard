        ...
        <div className='flex h-full flex-col'>
          <div className='flex items-center justify-between border-b border-slate-100 dark:border-white/20 p-[24px]'>
            <div className='flex items-center gap-[12px]'>
              <h3 className='text-[20px] font-bold text-theme-secondary dark:text-white'>Log Detail</h3>
          ...
          <div className='flex-grow overflow-y-auto p-[24px]'>
            <div className='mb-[24px]'>
              <div className='mb-[8px] text-[12px] font-semibold uppercase tracking-wider text-slate-400 dark:text-slate-200'>Event Message</div>
              <div className='rounded-[12px] border border-slate-100 dark:border-white/20 bg-slate-900 dark:bg-black/50 p-[24px] font-mono text-[13px] leading-relaxed text-slate-100 shadow-xl overflow-x-auto whitespace-pre-wrap'>
                {log.message}
              </div>
            </div>
            ...
            <div className='mt-[24px] rounded-[12px] bg-slate-50 dark:bg-black/20 p-[20px]'>
              <div className='text-[12px] font-bold text-slate-500 dark:text-slate-200 uppercase tracking-wide'>Context Metadata</div>
