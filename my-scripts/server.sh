...
gnome-terminal --tab --title="Sentinel Dashboard" --working-directory="/home/rinne/projects/my-package/my-realworld/tea-cup-realworld-admin/frontend" -- bash -c "npm run dev; exec bash"
